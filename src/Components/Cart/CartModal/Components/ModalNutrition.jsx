              ...
              <AccordionPanel pb={4}>
                ...
                <Box mt="20px">
                  <Text fontSize={"12px"} letterSpacing="3">
                    ...
                    different kitchens. While the info and ingredients found
                    here are meant to give you a general idea of a meal’s
                    nutrition facts, please always check the physical label on
                    the meal you’re about to eat for the most up-to-date
                    information.
                  </Text>
                </Box>
              </AccordionPanel>
