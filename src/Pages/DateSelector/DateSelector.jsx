    ...
    return (
        <div >
            <Box bg="#fffdf7" p={4} margin={'auto'} insetBlock={'0'}>
                <Heading mb={"3rem!important"} fontSize='3rem' fontWeight={500} color='#000' boxSize={"border-box"}>
                    Choose A Delivery Day</Heading>
                <div style={{
                    ...
                    <Button w="20em" bg="blue" color="white" borderRadius="0%" variant="outline" size="md" mt="2rem" mb={"2rem"}>
                       Next
                    </Button>
